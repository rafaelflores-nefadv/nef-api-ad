...
remove_member() {
    ...
    if ldapmodify -x \
        ...
        log_action "GROUP_REMOVE_MEMBERS" "Members removed from $groupname"
        json_success "{\"groupname\":\"$groupname\",\"members\":$members_json,\"message\":\"Members removed successfully\"}"
    else
        local error
